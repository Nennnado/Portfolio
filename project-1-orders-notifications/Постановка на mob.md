В этом разделе описаны операции, которые создаются для заказа и выполняются в мобильном приложении. Каждая операция проходит несколько статусов, взаимодействует с материалами и оборудованием, и может быть поставлена на паузу, отклонена или завершена.
