...
| 25 | errorDescription   | string      | нет          | Описание ошибки (только если метод отличается от 2XX) |
| 26 | id                 | int         | да           | Идентификатор заказа                            |
| 27 | orderNumber        | string      | нет          | Номер заказа                                    |
| 28 | orderName          | string      | нет          | Наименование заказа                             |
| 29 | orderTypeId        | int         | нет          | Идентификатор типа заказа                        |
| 30 | orderTypeName      | string      | нет          | Тип заказа                                      |
| 31 | statusId           | int         | нет          | Идентификатор статуса                            |
| 32 | statusName         | string      | нет          | Наименование статуса                             |
| 33 | equipmentId        | int         | нет          | Идентификатор оборудования                       |
| 34 | equipmentName      | string      | нет          | Наименование оборудования                        |
| 35 | eqCode             | string      | нет          | Код оборудования                                 |
| 36 | equipKindId        | int         | нет          | Ид вида оборудования                             |
| 37 | equipKindName      | string      | нет          | Наименование вида оборудования                   |
| 38 | startDate          | timestamp   | нет          | Дата и время начала (план)                        |
| 39 | endDate            | timestamp   | нет          | Дата и время окончания (план)                     |
| 40 | createDate         | timestamp   | нет          | Дата и время создания                              |
| 41 | actualStart        | timestamp   | нет          | Дата и время начала (факт)                         |
| 42 | actualEnd          | timestamp   | нет          | Дата и время окончания (факт)                      |
| 43 | hasExecutor        | boolean     | нет          | Признак наличия исполнителей                        |
| 44 | planMen            | string      | нет          | Количество человек (человеко-часы)                 |
| 45 | countMen           | string      | нет          | Количество человек, назначенных на заказ           |
| 46 | planTime           | string      | нет          | Количество времени (человеко-часы)                 |
| 47 | priorityDefectId   | int         | нет          | Идентификатор приоритета дефекта                   |
| 48 | priorityDefectName | string      | нет          | Наименование приоритета дефекта                    |
| 49 | planGroupId        | int         | нет          | Идентификатор группы плановиков                     |
| 50 | planGroupName      | string      | нет          | Наименование группы плановиков                      |
| 51 | actTypeId          | int         | нет          | ИД вида работ ТОРО                                   |
| 52 | actTypeName        | string      | нет          | Наименование вида работ ТОРО                         |
| 53 | plantId            | int         | нет          | Номер завода                                         |
| 54 | plantName          | string      | нет          | Наименование завода                                  |
| 55 | workCenterId       | int         | нет          | Id участка                                          |
| 56 | workCenterName     | string      | нет          | Наименование участка                                 |
| 57 | techPlaceId        | int         | нет          | Id тех. места                                        |
| 58 | techPlaceCode      | string      | нет          | Код тех. места                                       |
| 59 | techPlaceName      | string      | нет          | Наименование тех. места                               |
| 60 | defectId           | int         | нет          | Идентификатор дефекта                                  |
| 61 | defectNumber       | string      | нет          | Номер дефекта                                        |
| 62 | defects            | array       | нет          | Массив с данными о сообщении                           |
| 63 | requiresApproval   | bool        | нет          | Индикатор заказа, который требует утверждения        |
| 64 | priorityOrderId    | int         | нет          | Идентификатор приоритета заказа                        |
| 65 | priorityOrderName  | string      | нет          | Наименование приоритета заказа                         |
| 66 | total             | int          | нет          | Кол-во заказов переданных на выход                     |
| 67 | totalCurrent      | int          | нет          | Кол-во заказов текущих                                 |
| 68 | totalExpired      | int          | нет          | Кол-во просроченных заказов                             |
| 69 | totalDone         | int          | нет          | Кол-во выполненных заказов                               |
| 70 | page              | int          | нет          | Номер страницы                                          |
| 71 | size              | int          | нет          | Кол-во заказов на странице                               |
| 72 | totalAll          | int          | нет          | Кол-во всех заказов                                      |
| 73 | planDuration      | string       | нет          | Плановое время выполнения заказа                         |
| 74 | actualDuration    | string       | нет          | Фактическое время выполнения заказа                      |
